...
mlrmodel2 = lm(formula = sales ~ price, data=omni)#simple linear regression
...
#**R-sqaured tells 74% variance of sales 
#***the estimated std tell us that if price increases by 1 unit keeping the promotion
#const, sales decreases by -53
summary(mlrmodel2)
