...
frequentItems <- eclat (Groceries, parameter = list(supp = 0.005, minlen= 1,
                                                    maxlen = 15)) 
frequentItems
...
#verbose gives the information about the time taken
inspect(rules[1:15])
...
plot (rules[1:5], measure=c("support", "confidence"), shading="lift")
#plot(rules[1:5], method='graph', shading="confidence")
